...
# 암, 치아보험 현재(2023-01-29) 기준 필터 유효범위 충족하는 가설의 상품마스터 중 매핑이 안된 항목
select validated_plan.worker
       , prms.product_id
...
#        , cm_fixed_annuity_type.code_value as fixed_annuity_type   -- 연급타입_확정형
               ...
               from plan_mapper plmp
                        ...
                        join plan_master plms
                             on plmp.plan_id = plms.plan_id and plms.use_yn = 'Y' and plms.display_yn = 'Y' -- 사용중인 가설
                 ...
                 and (
                       ...
                       or (
                                   ...
                                   and (
                                               ...
                                               and (plan_type2 like '%1천만원%' or plan_type2 like '%3천만원%' or
                                               ...
                                               and (
                                                           ...
                                                           (
                                                                       ...
                                                                       (
                                                                               (cm_ins_term.code_value in ('80세') and
                                                                                cm_nap_term.code_value in
                                                                                ('10년', '20년'))
                                                                               or
                                                                               (cm_ins_term.code_value in ('100세') and
                                                                                cm_nap_term.code_value in
                                                                                ('10년', '20년'))
                                                                           )
                                                               )
...
where (prms.nuzal_tnd_codes = '' or prms.nuzal_tnd_codes is null)
group by prms.product_master_id
;
